...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/nikumar1206/loco/proto/oauth/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	OAuthServiceName = "proto.oauth.v1.OAuthService"
)
...
const (
	...
	OAuthServiceGithubOAuthDetailsProcedure = "/proto.oauth.v1.OAuthService/GithubOAuthDetails"
)

// OAuthServiceClient is a client for the proto.oauth.v1.OAuthService service.
...
// NewOAuthServiceClient constructs a client for the proto.oauth.v1.OAuthService service. By
...
func NewOAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OAuthServiceClient {
	...
	oAuthServiceMethods := v1.File_proto_oauth_v1_oauth_proto.Services().ByName("OAuthService").Methods()
...
// GithubOAuthDetails calls proto.oauth.v1.OAuthService.GithubOAuthDetails.
...
// OAuthServiceHandler is an implementation of the proto.oauth.v1.OAuthService service.
...
func NewOAuthServiceHandler(svc OAuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.oauth.v1.OAuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedOAuthServiceHandler) GithubOAuthDetails(context.Context, *connect.Request[v1.GithubOAuthDetailsRequest]) (*connect.Response[v1.GithubOAuthDetailsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.oauth.v1.OAuthService.GithubOAuthDetails is not implemented"))
}
