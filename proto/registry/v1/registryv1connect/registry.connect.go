...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/nikumar1206/loco/proto/registry/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	RegistryServiceName = "proto.registry.v1.RegistryService"
)
...
const (
	...
	// GitlabToken RPC.
	RegistryServiceGitlabTokenProcedure = "/proto.registry.v1.RegistryService/GitlabToken"
)

// RegistryServiceClient is a client for the proto.registry.v1.RegistryService service.
type RegistryServiceClient interface {
	GitlabToken(context.Context, *connect.Request[v1.GitlabTokenRequest]) (*connect.Response[v1.GitlabTokenResponse], error)
}

// NewRegistryServiceClient constructs a client for the proto.registry.v1.RegistryService service.
...
func NewRegistryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RegistryServiceClient {
	...
	registryServiceMethods := v1.File_proto_registry_v1_registry_proto.Services().ByName("RegistryService").Methods()
...
// GitlabToken calls proto.registry.v1.RegistryService.GitlabToken.
...
// RegistryServiceHandler is an implementation of the proto.registry.v1.RegistryService service.
...
func NewRegistryServiceHandler(svc RegistryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.registry.v1.RegistryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRegistryServiceHandler) GitlabToken(context.Context, *connect.Request[v1.GitlabTokenRequest]) (*connect.Response[v1.GitlabTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.registry.v1.RegistryService.GitlabToken is not implemented"))
}
